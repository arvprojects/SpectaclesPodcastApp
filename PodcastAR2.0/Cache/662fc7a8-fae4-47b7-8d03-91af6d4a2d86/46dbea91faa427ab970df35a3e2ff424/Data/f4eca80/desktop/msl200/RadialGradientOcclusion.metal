...
bool l9_629=(*sc_set2.UserUniforms).isProxyMode!=0;
if (l9_629)
{
...
float l9_634=l9_633;
float l9_635=l9_634;
float l9_636=(*sc_set2.UserUniforms).sc_ShadowDensity*l9_635;
float3 l9_637=mix((*sc_set2.UserUniforms).sc_ShadowColor.xyz,(*sc_set2.UserUniforms).sc_ShadowColor.xyz*l9_631.xyz,float3((*sc_set2.UserUniforms).sc_ShadowColor.w));
...
{
l9_643.x+=(*sc_set2.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_646=l9_645.xy*(*sc_set2.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_683=l9_675;
float4 l9_684=sc_set2.sc_ScreenTexture.sample(sc_set2.sc_ScreenTextureSmpSC,l9_682,bias(l9_683));
...
float3 l9_694=definedBlend(l9_692,l9_693,in.varStereoViewID,(*sc_set2.UserUniforms),sc_set2.intensityTexture,sc_set2.intensityTextureSmpSC);
...
{
l9_702=float4((*sc_set2.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_702=float4(0.0);
