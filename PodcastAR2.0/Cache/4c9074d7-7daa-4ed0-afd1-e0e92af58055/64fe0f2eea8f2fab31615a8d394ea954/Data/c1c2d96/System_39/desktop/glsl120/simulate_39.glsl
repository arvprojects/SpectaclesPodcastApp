...
gParticle=l9_6;
int l9_7=InstanceID;
int l9_8=(vfxOffsetInstancesRead+l9_7)*4;
int l9_9=l9_8/vfxTargetWidth;
vec2 l9_10=(vec2(ivec2(l9_8-(l9_9*vfxTargetWidth),l9_9))+vec2(0.5))/vec2(2048.0,vfxTargetSizeRead.y);
...
vec2 l9_111=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_112=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_113;
if (texture0.x<0.5)
{
l9_113=0.0;
