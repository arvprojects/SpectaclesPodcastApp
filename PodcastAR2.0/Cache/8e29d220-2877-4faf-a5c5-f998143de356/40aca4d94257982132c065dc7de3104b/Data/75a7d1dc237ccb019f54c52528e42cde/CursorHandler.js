...
class CursorHandler {
    constructor(options) {
        ...
        this.parentTransform = (_a = this.frame.object) === null || _a === void 0 ? void 0 : _a.getTransform();
        this.lockMode = false;
        ...
        this.interactorCursor = (_b = options.interactorCursor) !== null && _b !== void 0 ? _b : null;
    }
    /**
