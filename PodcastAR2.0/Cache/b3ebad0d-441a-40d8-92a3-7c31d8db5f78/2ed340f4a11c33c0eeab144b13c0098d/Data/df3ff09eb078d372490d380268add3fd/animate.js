...
function animate(config) {
    ...
    let running = true;
    let elapsedTime = 0;
    let easingFunction = exports.easingFunctions[(_a = config.easing) !== null && _a !== void 0 ? _a : "linear"];
    let start = (_b = config.start) !== null && _b !== void 0 ? _b : 0;
    let end = (_c = config.end) !== null && _c !== void 0 ? _c : 1;
    let range = end - start;
