...
//float4 glowColor 4288
//float brightness 4304
//float pinchBrightness 4308
//float pokeBrightness 4312
//float depthRef 4316
//}
...
float4 glowColor;
float brightness;
float pinchBrightness;
float pokeBrightness;
float depthRef;
};
struct sc_Bone_t
{
...
int l9_12=l9_7;
int param=mainTexLayout_tmp;
int param_1=l9_12;
float2 param_2=UVCoord_N2;
bool param_3=(int(SC_USE_UV_TRANSFORM_mainTex_tmp)!=0);
float3x3 param_4=(*sc_set2.UserUniforms).mainTexTransform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_mainTex_tmp,SC_SOFTWARE_WRAP_MODE_V_mainTex_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_mainTex_tmp)!=0);
float4 param_7=(*sc_set2.UserUniforms).mainTexUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_mainTex_tmp)!=0);
float4 param_9=(*sc_set2.UserUniforms).mainTexBorderColor;
float param_10=0.0;
...
float param_13=(*sc_set2.UserUniforms).pinchBrightness;
Output_N13=param_13;
float Output_N14=0.0;
float param_14=(*sc_set2.UserUniforms).pokeBrightness;
Output_N14=param_14;
float Output_N15=0.0;
Output_N15=fast::max(Output_N13,Output_N14);
float Output_N10=0.0;
Output_N10=((Output_N8*Output_N9)*Output_N12)*Output_N15;
...
float2 l9_107=l9_106.xy*(*sc_set2.UserUniforms).sc_CurrentRenderTargetDims.zw;
