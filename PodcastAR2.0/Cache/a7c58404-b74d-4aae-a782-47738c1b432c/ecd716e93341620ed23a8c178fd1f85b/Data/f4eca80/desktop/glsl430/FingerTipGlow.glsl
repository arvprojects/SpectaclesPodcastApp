...
uniform float pinchBrightness;
uniform float pokeBrightness;
...
#endif
vec3 l9_3=vec3(l9_2.xyz)*vec3(glowColor.xyz);
float l9_4=((glowColor.w*l9_2.w)*brightness)*max(pinchBrightness,pokeBrightness);
