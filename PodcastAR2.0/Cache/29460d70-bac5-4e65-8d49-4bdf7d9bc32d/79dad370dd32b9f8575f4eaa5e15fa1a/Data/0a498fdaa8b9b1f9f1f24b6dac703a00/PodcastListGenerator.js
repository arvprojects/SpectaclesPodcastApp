...
let GridContentCreator = class GridContentCreator extends BaseScriptComponent {
    onAwake() {
        this.spectaclesBackendClient = new SpectaclesBackendClient_1.SpectaclesBackendClient();
        this.specs = this.scr.getComponent(SpectaclesBackendClient_1.SpectaclesBackendClient.getTypeName());
        this.container = this.spotifyContainer.sceneObject.getComponent(ContainerFrame_1.ContainerFrame.getTypeName());
    ...
    __initialize() {
        ...
        this.onStateChangedCallback = (podcast) => {
            ...
            this.specs.triggerListeningToPodcast(user, podcasts.get(podcast));
