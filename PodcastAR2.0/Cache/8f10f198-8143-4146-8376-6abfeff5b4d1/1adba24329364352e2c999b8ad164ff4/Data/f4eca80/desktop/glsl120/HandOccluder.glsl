...
#endif
vec3 l9_23=mix(l9_21.xyz,definedBlend(l9_21.xyz,Tweak_N0.xyz).xyz,vec3(Tweak_N0.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_25=vec4(mix(vec3(1.0),Tweak_N0.xyz,vec3(Tweak_N0.w)),Tweak_N0.w);
}
#else
{
vec4 l9_26;
...
{
l9_27=clamp(Tweak_N0.w,0.0,1.0);
}
#else
{
l9_27=Tweak_N0.w;
...
#endif
l9_26=vec4(Tweak_N0.xyz*l9_27,l9_27);
}
#else
{
l9_26=Tweak_N0;
