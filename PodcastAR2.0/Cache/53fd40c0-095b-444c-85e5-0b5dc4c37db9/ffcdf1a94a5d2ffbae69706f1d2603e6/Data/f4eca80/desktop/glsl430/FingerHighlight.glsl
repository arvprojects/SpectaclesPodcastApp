...
#endif
float l9_3=mix(Port_Input0_N003,indexBrightness,l9_2.x);
vec4 l9_4=vec4(indexGlowColor.xyz,l9_3);
vec3 l9_5=l9_4.xyz*l9_3;
vec4 l9_6=vec4(l9_5.x,l9_5.y,l9_5.z,l9_4.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_2.y))*(1.0-l9_3));
float l9_7=l9_6.w;
...
{
l9_13=clamp(dot(l9_6.xyz,vec3(l9_7)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*l9_7;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*l9_7;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_18;
#if (sc_BlendMode_Add)
{
l9_18=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*l9_7;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_6.xyz,vec3(0.33333001))*l9_7;
}
#else
{
float l9_21;
#if (sc_BlendMode_Min)
{
l9_21=1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_22;
#if (sc_BlendMode_Max)
{
l9_22=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_22=1.0;
...
#endif
l9_10=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_6.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_11);
}
#else
{
vec4 l9_23;
...
#endif
vec3 l9_34=mix(l9_32.xyz,definedBlend(l9_32.xyz,l9_6.xyz).xyz,vec3(l9_7));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_36=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_7)),l9_7);
}
#else
{
vec4 l9_37;
...
#endif
l9_37=vec4(l9_6.xyz*l9_38,l9_38);
}
#else
{
l9_37=l9_6;
