...
float l9_2=mix(Port_Input0_N003,indexBrightness,l9_1.x);
vec4 l9_3=vec4(indexGlowColor.xyz,l9_2);
vec3 l9_4=l9_3.xyz*l9_2;
vec4 l9_5=vec4(l9_4.x,l9_4.y,l9_4.z,l9_3.w)+(vec4(thumbGlowColor.xyz,mix(Port_Input0_N011,thumbBrightness,l9_1.y))*(1.0-l9_2));
float l9_6=l9_5.w;
...
{
l9_10=clamp(dot(l9_5.xyz,vec3(l9_6)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_5.xyz,vec3(0.33333001)))*l9_6;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0))*l9_6;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_15;
#if (sc_BlendMode_Add)
{
l9_15=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0)*l9_6;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_5.xyz,vec3(0.33333001))*l9_6;
}
#else
{
float l9_18;
#if (sc_BlendMode_Min)
{
l9_18=1.0-clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_19;
#if (sc_BlendMode_Max)
{
l9_19=clamp(dot(l9_5.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_19=1.0;
...
#endif
l9_7=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_5.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_8);
}
#else
{
vec4 l9_20;
...
#endif
l9_22=sc_SampleView(sc_ScreenTextureDims.xy,l9_26,sc_ScreenTextureLayout,l9_27,0.0,sc_ScreenTexture);
}
#endif
vec4 l9_28;
...
{
vec4 l9_29=l9_22;
l9_29.x=l9_22.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_28=l9_29;
}
#else
{
...
#endif
vec3 l9_30=mix(l9_28.xyz,definedBlend(l9_28.xyz,l9_5.xyz).xyz,vec3(l9_6));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_32=vec4(mix(vec3(1.0),l9_5.xyz,vec3(l9_6)),l9_6);
}
#else
{
vec4 l9_33;
...
#if (sc_OITCompositingPass)
{
vec2 l9_55=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
#if (sc_OITMaxLayers4Plus1)
{
