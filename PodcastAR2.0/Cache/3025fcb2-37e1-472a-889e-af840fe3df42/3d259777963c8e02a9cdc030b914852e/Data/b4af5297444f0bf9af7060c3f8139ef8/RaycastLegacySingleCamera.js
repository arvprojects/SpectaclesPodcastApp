...
class RaycastLegacySingleCamera extends RaycastBase_1.default {
    ...
    getRay() {
        if (this.hand.middleKnuckle === null) {
            ...
            let targetingRay = this.hand.middleKnuckle.position.sub(this.calculateRayDirectionAnchor());
            (0, validate_1.validate)(this.locusOneEuroFilter);
            (0, validate_1.validate)(this.directionOneEuroFilter);
            return {
