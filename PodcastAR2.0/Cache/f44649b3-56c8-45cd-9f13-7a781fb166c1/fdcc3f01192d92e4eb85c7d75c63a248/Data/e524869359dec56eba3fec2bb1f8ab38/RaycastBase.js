...
class RaycastBase {
    ...
    calculateCastAnchor(thumbKnuckle, middleKnuckle) {
        let middleFingerThumbOffset = middleKnuckle.sub(thumbKnuckle);
        let rootMiddleFinger = this.knuckleOneEuroFilter
    ...
    getWrist() {
        ...
        if (this.hand.wrist === null)
            return null;
        return ((_b = (_a = this.wristOneEuroFilter) === null || _a === void 0 ? void 0 : _a.filter(this.hand.wrist.position, getTime())) !== null && _b !== void 0 ? _b : null);
    }
    /**
    ...
    filterHandZAverage(cameraToWorld) {
        (0, validate_1.validate)(this.handZOneEuroFilter);
        let zAverage = 0;
        let length = 0;
