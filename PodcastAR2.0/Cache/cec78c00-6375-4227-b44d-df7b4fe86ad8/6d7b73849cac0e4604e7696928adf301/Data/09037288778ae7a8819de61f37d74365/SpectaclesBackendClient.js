...
let SpectaclesBackendClient = class SpectaclesBackendClient extends BaseScriptComponent {
    ...
    async triggerListeningToPodcast(username, podcastId) {
    ...
    async instantiateImage(data) {
        ...
        let container = newContainer.getChild[0].getComponent(ContainerFrame_1.ContainerFrame.getTypeName());
        ...
        httpRequest.url = "https://arvpodcastmedia.s3.us-east-2.amazonaws.com/arv_podcasts/us_tarrifs.png";
