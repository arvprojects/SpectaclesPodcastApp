...
class DefaultHeadlockController {
    ...
    resetPosition() {
        ...
        let pitchQuaternion = quat.angleAxis(MathUtils.DegToRad * ((_a = this.headlockComponent.pitchOffsetDegrees) !== null && _a !== void 0 ? _a : 0), vec3.left());
        offset = pitchQuaternion.multiplyVec3(offset);
        let yawQuaternion = quat.angleAxis(MathUtils.DegToRad * ((_b = this.headlockComponent.yawOffsetDegrees) !== null && _b !== void 0 ? _b : 0), vec3.up());
