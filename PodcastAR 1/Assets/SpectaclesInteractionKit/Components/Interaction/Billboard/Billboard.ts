...
@input
@hint('How fast the target should rotate to follow camera, instant follow = 1, delay follow = 0.1')
private _axisEasing: vec3 = new vec3(1, 1, 1);
@input
@hint('The expected duration between updates, expecting ~30FPS = 0.033; lower duration = faster rotation')
@ui.group_end
